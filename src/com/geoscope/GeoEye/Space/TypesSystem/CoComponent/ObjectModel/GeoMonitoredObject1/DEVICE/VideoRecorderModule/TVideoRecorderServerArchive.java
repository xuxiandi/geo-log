...
public class TVideoRecorderServerArchive extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        lvVideoRecorderServerArchive.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
	    		...
	    		int SelectedIdx = -1;
	    		if ((MeasurementDescriptor != null) && MeasurementDescriptor.IsTypeOf(com.geoscope.GeoLog.DEVICE.SensorsModule.Measurements.AV.TMeasurementDescriptor.TypeIDPrefix)) {
	...
	public static TArchiveItem[] GetItemsList(double BeginTimestamp, double EndTimestamp, TCoGeoMonitorObject Object, String GeographDataServerAddress, int GeographDataServerPort, Context context, TCanceller Canceller) throws Exception {
		...
		try {
			SVRMs = TSensorMeasurement.Filter(GeographDataServerClient.SERVICE_GETSENSORDATA_GetMeasurementList(BeginTimestamp,EndTimestamp, Canceller), com.geoscope.GeoLog.DEVICE.SensorsModule.Measurements.AV.TMeasurementDescriptor.TypeIDPrefix);
		}
		finally {
