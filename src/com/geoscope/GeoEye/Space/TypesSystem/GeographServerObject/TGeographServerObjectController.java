...
public class TGeographServerObjectController extends TGeographServerClient {
    ...
    public TGeographServerObjectController(Context pcontext, String pServerAddress, int pServerPort, int pUserID, String pUserPassword, int pidGeoGraphServerObject, int pObjectID) {
