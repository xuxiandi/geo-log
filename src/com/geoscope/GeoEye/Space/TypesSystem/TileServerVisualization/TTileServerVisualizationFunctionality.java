...
public class TTileServerVisualizationFunctionality extends TBase2DVisualizationFunctionality {
		...
		try {
			...
			try {
				...
				try {
					...
					//.
					TTileServerVisualizationData Result = new TTileServerVisualizationData();
	...
	public TTileServerVisualizationData GetData() throws Exception {
		return (TTileServerVisualizationData)_GetData();
	}
}
