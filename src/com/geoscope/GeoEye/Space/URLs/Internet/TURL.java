...
public class TURL extends com.geoscope.GeoEye.Space.URLs.TURL {
	...
	public TThumbnailImageComposition GetThumbnailImageComposition() {
		return (new TThumbnailImageComposition(BitmapFactory.decodeResource(User.Server.context.getResources(), R.drawable.user_activity_component_list_placeholder_internet))); 
	}
