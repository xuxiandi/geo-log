...
public class TUserActivityComponentListComponent extends TUIComponent {
	...
	public static final int REQUEST_COMPONENT_CONTENT 			= 201;
	public static final int REQUEST_COMPONENT_CHANGESECURITY 	= 202;
	public static final int REQUEST_SELECT_USER_FORURL 			= 203;
        ...
        lvActivityComponentList.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				try {
		    		...
		    		_items[4] = ParentActivity.getString(R.string.SSendURLLinkToUser); 
		    		_items[5] = ParentActivity.getString(R.string.SSetName); 
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_COMPONENT_CHANGESECURITY: 
        	if (resultCode == Activity.RESULT_OK) {
        		int SI = lvActivityComponentListAdapter.Items_GetSelectedIndex();
        		if (SI >= 0) {
            		final long SecurityFileID = data.getExtras().getLong("SecurityFileID");
            		final TActivity.TComponent _Component = ActivityComponents.Items[SI];
    				TAsyncProcessing SecurityChanging = new TAsyncProcessing(ParentActivity, ParentActivity.getString(R.string.SChangingSecurity)) {
