 ...
 * @author ALXPONOM
 */
public class TObjectSetDataStreamerActiveFlagSO extends TObjectSetComponentDataServiceOperation
{
    ...
    public TObjectSetDataStreamerActiveFlagSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short[] pSubAddress)
    {
