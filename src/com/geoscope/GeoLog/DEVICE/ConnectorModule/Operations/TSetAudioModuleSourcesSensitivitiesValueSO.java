 ...
 * @author ALXPONOM
 */
public class TSetAudioModuleSourcesSensitivitiesValueSO extends TDeviceSetComponentDataServiceOperation
{
    public static TElementAddress _Address = new TElementAddress(2,13,1001);
    
    public TSetAudioModuleSourcesSensitivitiesValueSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short pSession, short[] pSubAddress)
    {
    ...
    {
        return Connector.Device.AudioModule.SourcesSensitivitiesValue;
    }
