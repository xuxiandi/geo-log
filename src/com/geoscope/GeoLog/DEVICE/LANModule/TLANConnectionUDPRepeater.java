...
public class TLANConnectionUDPRepeater extends TConnectionUDPRepeater {
	...
	public TLANConnectionUDPRepeater(TLANModule pLANModule, String pSourceAddress, int pSourcePort, String pServerAddress, int pServerPort, String pDestinationUDPAddress, int pDestinationUDPPort, int pConnectionID, String pUserAccessKey) {
