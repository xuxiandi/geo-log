...
public class TLANLocalVirtualConnectionRepeater extends TConnectionRepeater {
	...
	public TLANLocalVirtualConnectionRepeater(TLANModule pLANModule, String pDestinationAddress, int pDestinationPort, int pConnectionID, String pUserAccessKey) {
