...
public class TObjectGetVideoRecorderSavingServerValueSO extends TObjectGetComponentDataServiceOperation
{
    ...
    public TObjectGetVideoRecorderSavingServerValueSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short[] pSubAddress)
    {
