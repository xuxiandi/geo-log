...
public class TVideoRecorderActiveValue extends TComponentTimestampedBooleanValue {

	private TVideoRecorderModule VideoRecorderModule;
	
	public TVideoRecorderActiveValue(TVideoRecorderModule pVideoRecorderModule) {
