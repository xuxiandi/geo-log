...
public class TEnforaObjectDeviceSchema extends TComponentSchema {

	public class TEnforaObjectDeviceComponent extends TComponent {
		...
		public TEnforaObjectDeviceComponent() throws Exception {
			...
			BatteryModule 		= new TBatteryModule		(this,5);
			DeviceDescriptor	= new TDeviceDescriptor		(this,6);
		}
	}
	
	public TEnforaObjectDeviceSchema(TObjectModel pObjectModel) throws Exception {
		super(pObjectModel);
		RootComponent = new TEnforaObjectDeviceComponent();
	}
}
