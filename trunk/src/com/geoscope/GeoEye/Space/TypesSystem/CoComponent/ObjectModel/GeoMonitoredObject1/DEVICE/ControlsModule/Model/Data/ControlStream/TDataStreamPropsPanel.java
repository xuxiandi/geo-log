			...
			try {
				try {
	    			...
	    			try {
	    				...
	    				//.
	    				try {
	    					DataStreamDescriptor = new TStreamDescriptor(DataStreamDescriptorData,com.geoscope.GeoEye.Space.TypesSystem.CoComponent.ObjectModel.GeoMonitoredObject1.DEVICE.ControlsModule.Model.Data.ControlStream.Channels.TChannelsProvider.Instance);
	    				}
	    				catch (Exception E) {
