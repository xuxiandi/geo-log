...
import com.geoscope.GeoEye.Space.TypesSystem.CoComponent.ObjectModel.GeoMonitoredObject1.DEVICE.LANModule.TLANConnectionUDPRepeater;
	...
	public static class TAudioClient extends TCancelableThread {
		...
		public void DecodeInputBuffer(byte[] input, int input_size) throws IOException {
			...
			if (outputBufferIndex == MediaCodec.INFO_OUTPUT_BUFFERS_CHANGED) 
				...
				AudioPlayer = new AudioTrack(Destination, SampleRate, ChannelConfig, AudioFormat.ENCODING_PCM_16BIT, BufferSize, AudioTrack.MODE_STREAM);
