...
import com.geoscope.GeoEye.Space.TypesSystem.DataStream.Model.Data.Stream.TStreamChannelConnector;
import com.geoscope.GeoEye.Space.TypesSystem.DataStream.Model.Data.Stream.TStreamChannelConnectorAbstract;
...
public class TDataStreamPanel extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	try {
            ...
            if (extras != null) {
            	...
            	//.
            	StreamDescriptorData = extras.getByteArray("StreamDescriptor");
            	//.
            	...
            	if (StreamChannelsBA != null) 
            		...
            		StreamChannels = null;
            	//.
        		StreamDescriptor = new TStreamDescriptor(StreamDescriptorData, com.geoscope.GeoEye.Space.TypesSystem.DataStream.Model.Data.Stream.Channels.TChannelsProvider.Instance);
            }
            //.
	...
	private void StreamChannelConnectors_Finalize() throws Exception {
		for (int I = 0; I < StreamChannelConnectors.size(); I++) 
			StreamChannelConnectors.get(I).Destroy();
	...
	protected TStreamChannelConnectorAbstract StreamChannelConnectors_CreateOneForChannel(TStreamChannel Channel) throws Exception {
		TStreamChannelConnectorAbstract ChannelConnector = new TStreamChannelConnector(this, ServerAddress,ServerPort, UserID,UserPassword, SpaceDefines.idTDataStream,idComponent, Channel, new TStreamChannel.TOnProgressHandler(Channel) {
			
			@Override
			public void DoOnProgress(int ReadSize, TCanceller Canceller) {
				TDataStreamPanel.this.PostStatusMessage("");
			}
		}, new TStreamChannel.TOnIdleHandler(Channel) {
		...
		}, new TStreamChannel.TOnExceptionHandler(Channel) {
