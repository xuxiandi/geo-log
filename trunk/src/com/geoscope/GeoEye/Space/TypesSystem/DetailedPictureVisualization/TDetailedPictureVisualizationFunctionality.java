...
public class TDetailedPictureVisualizationFunctionality extends TComponentFunctionality {
	...
	public TDetailedPictureVisualizationFunctionality(TTypeFunctionality pTypeFunctionality, int pidComponent) {
		...
		try {
			...
			try {
				...
				try {
					...
					//.
					TDetailedPictureVisualizationData Result = new TDetailedPictureVisualizationData();
	...
	public TDetailedPictureVisualizationData GetData() throws Exception {
		return (TDetailedPictureVisualizationData)_GetData();
	}
}
