...
import com.geoscope.GeoLog.DEVICE.AlarmModule.TAlarmDataValue;
 ...
 * @author ALXPONOM
 */
public class TObjectSetAlarmDataSO extends TObjectSetComponentDataServiceOperation
{
    ...
    public TObjectSetAlarmDataSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short[] pSubAddress)
    {
    ...
    {
    	TAlarmDataValue value = (TAlarmDataValue)Value;
        Datas[0] = value;
        Datas_Count = 1;
    }
    ...
    public synchronized void FromByteArray(byte[] BA, TIndex Idx) throws IOException, OperationException
    {
        ...
        {
        	TAlarmDataValue Value = new TAlarmDataValue();
