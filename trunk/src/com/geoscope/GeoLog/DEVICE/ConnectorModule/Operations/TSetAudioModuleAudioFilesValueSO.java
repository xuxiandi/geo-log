 ...
 * @author ALXPONOM
 */
public class TSetAudioModuleAudioFilesValueSO extends TDeviceSetComponentDataServiceOperation
{
    public static TElementAddress _Address = new TElementAddress(2,13,1101);
    
    public TSetAudioModuleAudioFilesValueSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short pSession, short[] pSubAddress)
    {
