 ...
 * @author ALXPONOM
 */
public class TSetVideoRecorderTransmittingValueSO extends TDeviceSetComponentDataServiceOperation
{
    public static TElementAddress _Address = new TElementAddress(2,9,6);
    
    public TSetVideoRecorderTransmittingValueSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short pSession, short[] pSubAddress)
    {
    ...
    public synchronized TComponentValue getValue() throws OperationException
    {
        ...
        return Connector.Device.VideoRecorderModule.Transmitting;
    }
    ...
    public synchronized int DoOnOperationCompletion() throws OperationException, InterruptedException, IOException
    {
        if (Connector.Device.VideoRecorderModule.CompletionHandler != null) 
        	Connector.Device.VideoRecorderModule.CompletionHandler.obtainMessage(TVideoRecorderModule.MESSAGE_OPERATION_COMPLETED,Connector.Device.VideoRecorderModule.Transmitting).sendToTarget();        	
