 ...
 * @author ALXPONOM
 */
public class TSetVideoRecorderVideoValueSO extends TDeviceSetComponentDataServiceOperation
{
    public static TElementAddress _Address = new TElementAddress(2,9,5);
    
    public TSetVideoRecorderVideoValueSO(TConnectorModule pConnector, int pUserID, String pUserPassword, int pObjectID, short pSession, short[] pSubAddress)
    {
    ...
    public synchronized TComponentValue getValue() throws OperationException
    {
        ...
        return Connector.Device.VideoRecorderModule.Video;
    }
    ...
    public synchronized int DoOnOperationCompletion() throws OperationException, InterruptedException, IOException
    {
        if (Connector.Device.VideoRecorderModule.CompletionHandler != null) 
        	Connector.Device.VideoRecorderModule.CompletionHandler.obtainMessage(TVideoRecorderModule.MESSAGE_OPERATION_COMPLETED,Connector.Device.VideoRecorderModule.Video).sendToTarget();        	
