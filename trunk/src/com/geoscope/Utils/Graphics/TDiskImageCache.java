package com.geoscope.Utils.Graphics;
...
import com.geoscope.Utils.TDiskLruCache;

public class TDiskImageCache {

	private TDiskLruCache mDiskCache;
	...
	private boolean writeBitmapToFile(Bitmap bitmap, TDiskLruCache.Editor editor)
			throws IOException, FileNotFoundException {
		OutputStream out = null;
		try {
			out = new BufferedOutputStream(editor.newOutputStream(0),
					TDiskLruCache.Utils.IO_BUFFER_SIZE);
	...
	private File getDiskCacheDir(Context context, String uniqueName) {
		...
		final String cachePath = Environment.MEDIA_MOUNTED.equals(Environment
				...
				|| !TDiskLruCache.Utils.isExternalStorageRemovable() ? TDiskLruCache.Utils
	...
	public void put(String key, Bitmap data) {
		...
		TDiskLruCache.Editor editor = null;
		try {
	...
	public Bitmap getBitmap(String key) {
		...
		Bitmap bitmap = null;
		TDiskLruCache.Snapshot snapshot = null;
		try {
